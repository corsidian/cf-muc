...
import net.emiva.crossfire.plugin.muc.spi.IQAdminHandler;
import net.emiva.crossfire.plugin.muc.spi.IQOwnerHandler;
import net.emiva.crossfire.plugin.muc.spi.LocalMUCRole;
import net.emiva.crossfire.plugin.muc.spi.LocalMUCUser;
