...
import net.emiva.crossfire.disco.DiscoInfoProvider;
import net.emiva.crossfire.disco.DiscoItem;
import net.emiva.crossfire.disco.DiscoItemsProvider;
import net.emiva.crossfire.disco.DiscoServerItem;
import net.emiva.crossfire.disco.ServerItemsProvider;
import net.emiva.crossfire.plugin.muc.HistoryStrategy;
import net.emiva.crossfire.plugin.muc.MUCEventDelegate;
...
import net.emiva.crossfire.plugin.muc.MUCUser;
import net.emiva.crossfire.plugin.muc.MultiUserChatService;
import net.emiva.crossfire.plugin.muc.NotAllowedException;
import net.emiva.crossfire.plugin.muc.cluster.GetNumberConnectedUsers;
import net.emiva.crossfire.plugin.muc.cluster.OccupantAddedEvent;
import net.emiva.crossfire.plugin.muc.cluster.RoomAvailableEvent;
import net.emiva.crossfire.plugin.muc.cluster.RoomRemovedEvent;
...
public class MultiUserChatServiceImpl implements Component, MultiUserChatService,
    ...
    public void initializeSettings() {
        serviceEnabled = GlobalProperties.getInstance().getBooleanProperty("xmpp.muc.enabled", true);
