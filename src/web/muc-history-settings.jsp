...
<%@ page import="net.emiva.util.*,
                 java.util.*,                  
                 net.emiva.crossfire.plugin.muc.HistoryStrategy,
                 net.emiva.crossfire.plugin.muc.MultiUserChatService,
...
<%   // Get parameters:
    ...
    if (!plugin.getMultiUserChatManager().isServiceRegistered(mucname)) {
    ...
    // Get muc server
    MultiUserChatService mucService = plugin.getMultiUserChatManager().getMultiUserChatService(mucname);
...
<meta name="subPageID" content="plugin-muc-history"/>
