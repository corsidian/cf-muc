...
<%@ page import="org.dom4j.Element,
                 net.emiva.crossfire.plugin.muc.ConflictException,
                 net.emiva.crossfire.plugin.muc.MUCRoom,
                 net.emiva.crossfire.plugin.muc.NotAllowedException,
...
<%@ page import="net.emiva.crossfire.plugin.muc.CannotBeInvitedException" %>
...
<%  // Get parameters
    ...
    MUCRoom room = plugin.getMultiUserChatManager().getMultiUserChatService(roomJID).getChatRoom(roomName);
...
<html>
    <head>
        ...
        <meta name="subPageID" content="plugin-muc-room-affiliations"/>
