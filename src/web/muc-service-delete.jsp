...
<%  // Get parameters //
    ...
    MultiUserChatService muc = plugin.getMultiUserChatManager().getMultiUserChatService(mucname);
    ...
    if (delete) {
        ...
        if (muc != null) {
            ...
            plugin.getMultiUserChatManager().removeMultiUserChatService(mucname);
        }
        // Done, so redirect
...
<html>
    <head>
        ...
        <meta name="subPageID" content="plugin-muc-service-delete"/>
