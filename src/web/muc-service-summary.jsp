...
<html>
    <head>
        ...
        <meta name="pageID" content="plugin-muc-service-summary"/>
    </head>
    <body>
...
<%  // Get parameters
    ...
    int servicesCount = plugin.getMultiUserChatManager().getServicesCount(false);
...
<%  // Print the list of users
    List<MultiUserChatService> services = plugin.getMultiUserChatManager().getMultiUserChatServices();
    if (services.isEmpty()) {
%>
    <tr>
